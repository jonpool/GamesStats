 ...
 */
public class FeedTodosJogos extends BaseAdapter {
    private TOfeedGames recentes;
    private Context context;


    public FeedTodosJogos(TOfeedGames recentes, Context context){
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        String hotasTotais = String.format("%.01f",horas);
